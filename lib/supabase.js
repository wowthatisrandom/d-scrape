...
// If productCount is undefined, don't update last_product_count (preserves existing value)
async function updateDispensaryStatus(dispensaryId, status, errorMessage, productCount) {
  ...
  // Only update last_product_count if explicitly provided
  // This allows preserving the previous count on likely scrape failures
