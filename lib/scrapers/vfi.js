...
class VFIScraper extends BaseScraper {
  ...
  filterProducts(products) {
    ...
    return products.filter(product => {
      ...
      // Must match brand filter (ace) or jackpot (Ace sub-brand)
      const matchesBrand = brand.includes(filterLower) || brand.includes('jackpot');
      const matchesName = name.includes(filterLower) || name.includes('jackpot');
