...
class TreezScraper extends BaseScraper {
  ...
  filterProducts(products) {
    ...
    return products.filter(product => {
      ...
      // Check if "ace" or "jackpot" (Ace sub-brand) is in brand or full name
      const isAceBrand = brand.includes('ace') || brand.includes('jackpot');
      const isAceProduct = fullName.includes('ace') || fullName.includes('jackpot');
